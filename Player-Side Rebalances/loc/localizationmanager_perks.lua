Hooks:Add("LocalizationManagerPostInit", "Oryo Perk Deck Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["menu_deck10_9_desc"] = 	"Medical Supplies grant you ##3%## to ##7%## critical hit chance for ##7.5## seconds. " ..
        ...
        ["menu_deck12_9_desc"] =    "All berserker state effects in this perk deck will start at ##50%## health instead of ##25%##.\n\n" ..
                                    "Shallow Grave:\n" ..
                                    "When an enemy deals lethal damage to you, you gain the ability to keep fighting for ##3.5## seconds before being downed. " ..
                                    "If your armor recovers before the end of this effect, your health is restored to before you took lethal damage and you do not become downed. " ..
